...
<header class="flex justify-between items-center border-b border-gray-200 px-5 py-4 bg-white">
  <div class="flex items-center gap-2.5">
    ...
    <h1 class="font-bold text-xl leading-none m-0">Acme</h1>
  </div>
  <div class="flex items-center gap-2.5">
    {#if user}
      <span class="text-gray-800 text-sm mr-2.5">
